...
public final class GlobalExceptionHandler {
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ResponseEntity<Response> badRequestException(final BadRequestException ex) {
    Response response = new Response();
    response.setMessage(ex.getLocalizedMessage());
    response.setDescription("There is no such object");
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response);
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ResponseEntity<Response> handleMissingServletRequestParametersException(
  ...
  public ResponseEntity<Response> handleHttpsRequestMethodNotSupportedException(
